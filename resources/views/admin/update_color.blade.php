            ...
            <div class="row">
                <div class="col-xl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form action="{{url('/update_color_confirm',$color->id)}}" method="POST">
                      @csrf
                        <div class="mb-3">
                          <input type="text" name="color" class="form-control" id="basic-default-fullname" required="" value="{{$color->color}}" />
                        </div>   
