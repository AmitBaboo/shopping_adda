                        ...
                        <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                            ...
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{asset('frontend_layout/assets/images/demos/demo-2/products/product-1-1.jpg')}}" alt="Product image" class="product-image">
                                        <img src="{{asset('frontend_layout/assets/images/demos/demo-2/products/product-1-2.jpg')}}" alt="Product image" class="product-image-hover">
                                    </a>
                            ...
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{asset('frontend_layout/assets/images/demos/demo-2/products/product-2-1.jpg')}}" alt="Product image" class="product-image">
                                        <img src="{{asset('frontend_layout/assets/images/demos/demo-2/products/product-2-2.jpg')}}" alt="Product image" class="product-image-hover">
                                    </a>
                            ...
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    ...
                                    <a href="product.html">
                                        <img src="{{asset('frontend_layout/assets/images/demos/demo-2/products/product-3-1.jpg')}}" alt="Product image" class="product-image">
                                        <img src="{{asset('frontend_layout/assets/images/demos/demo-2/products/product-3-2.jpg')}}" alt="Product image" class="product-image-hover">
                                    </a>
                            ...
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    ...
                                    <a href="product.html">
                                        <img src="{{asset('frontend_layout/assets/images/demos/demo-2/products/product-4-1.jpg')}}" alt="Product image" class="product-image">
                                        <img src="{{asset('frontend_layout/assets/images/demos/demo-2/products/product-4-2.jpg')}}" alt="Product image" class="product-image-hover">
                                    </a>
                            ...
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{asset('frontend_layout/assets/images/demos/demo-2/products/product-5-1.jpg')}}" alt="Product image" class="product-image">
                                        <img src="{{asset('frontend_layout/assets/images/demos/demo-2/products/product-5-2.jpg')}}" alt="Product image" class="product-image-hover">
                                    </a>
                            ...
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{asset('frontend_layout/assets/images/demos/demo-2/products/product-6-1.jpg')}}" alt="Product image" class="product-image">
                                        <img src="{{asset('frontend_layout/assets/images/demos/demo-2/products/product-6-2.jpg')}}" alt="Product image" class="product-image-hover">
                                    </a>
