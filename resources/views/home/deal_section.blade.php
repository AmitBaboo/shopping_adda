                    ...
                    <div class="row">
                        <div class="col-lg-9">
                            <div class="deal">
                                ...
                                <div class="deal-image">
                                    <a href="product.html">
                                        <img src="{{asset('frontend_layout/assets/images/demos/demo-2/deal/product-1.jpg')}}" alt="image">
                                    </a>
                                </div><!-- End .deal-image -->
                            </div><!-- End .deal -->
                        </div><!-- End .col-lg-9 -->
                        ...
                        <div class="col-lg-3">
                            <div class="banner banner-overlay banner-overlay-light text-center d-none d-lg-block">
                                <a href="#">
                                    <img src="{{asset('frontend_layout/assets/images/demos/demo-2/banners/banner-5.jpg')}}" alt="Banner">
                                </a>
