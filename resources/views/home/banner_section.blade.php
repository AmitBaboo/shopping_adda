                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-5">
                            <div class="banner banner-large banner-overlay banner-overlay-light">
                                <a href="#">
                                    <img src="{{asset('frontend_layout/assets/images/demos/demo-2/banners/banner-1.jpg')}}" alt="Banner">
                                </a>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="banner banner-overlay">
                                <a href="#">
                                    <img src="{{asset('frontend_layout/assets/images/demos/demo-2/banners/banner-2.jpg')}}" alt="Banner">
                                </a>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="banner banner-overlay">
                                <a href="#">
                                    <img src="{{asset('frontend_layout/assets/images/demos/demo-2/banners/banner-3.jpg')}}" alt="Banner">
                                </a>
                            ...
                            <div class="banner banner-overlay banner-overlay-light">
                                <a href="#">
                                    <img src="{{asset('frontend_layout/assets/images/demos/demo-2/banners/banner-4.jpg')}}" alt="Banner">
                                </a>
