<footer class="footer footer-2">
        	...
        	<div class="footer-newsletter bg-image" style="background-image: url(frontend_layout/assets/images/backgrounds/bg-2.jpg)">
        		<div class="container">
	            	...
	            	<div class="row">
	            		<div class="col-sm-12 col-lg-6">
	            			<div class="widget widget-about">
	            				<img src="{{asset('frontend_layout/assets/images/demos/demo-2/logo.png')}}" class="footer-logo" alt="Footer Logo" width="105" height="25">
	            					...
	            					<div class="row">
	            						...
	            						<div class="col-sm-6 col-md-8">
	            							...
	            							<figure class="footer-payments">
							        			<img src="{{asset('frontend_layout/assets/images/payments.png')}}" alt="Payment methods" width="272" height="20">
